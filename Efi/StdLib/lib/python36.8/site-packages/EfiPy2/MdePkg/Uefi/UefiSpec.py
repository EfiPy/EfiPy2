...
EFI_MEMORY_HOT_PLUGGABLE    = 0x0000000000100000
EFI_MEMORY_RUNTIME          = 0x8000000000000000
EFI_MEMORY_ISA_VALID        = 0x4000000000000000
EFI_MEMORY_ISA_MASK         = 0x0FFFF00000000000

EFI_CACHE_ATTRIBUTE_MASK    = (EFI_MEMORY_UC | EFI_MEMORY_WC | EFI_MEMORY_WT | EFI_MEMORY_WB | EFI_MEMORY_UCE | EFI_MEMORY_WP)
EFI_MEMORY_ACCESS_MASK      = (EFI_MEMORY_RP | EFI_MEMORY_XP | EFI_MEMORY_RO)
EFI_MEMORY_ATTRIBUTE_MASK   = (EFI_MEMORY_ACCESS_MASK | EFI_MEMORY_SP | EFI_MEMORY_CPU_CRYPTO)
