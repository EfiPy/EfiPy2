...
TCG_SPDM_CHALLENGE_DESCRIPTION         = b"SPDM CHALLENGE\0"
TCG_SPDM_CHALLENGE_AUTH_DESCRIPTION    = b"SPDM CHALLENGE_AUTH\0"
TCG_SPDM_GET_MEASUREMENTS_DESCRIPTION  = b"SPDM GET_MEASUREMENTS\0"
TCG_SPDM_MEASUREMENTS_DESCRIPTION      = b"SPDM MEASUREMENTS\0"
...
class TCG_NV_INDEX_DYNAMIC_EVENT_LOG_STRUCT_SPDM_CHALLENGE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ...
    ("DescriptionSize",   UINT16                               ),
    ("Description",       UINT8 * len (TCG_SPDM_CHALLENGE_DESCRIPTION)),
    ("DataSize",          UINT16),
    ("Data",              UINT8 * 32)
  ]
...
class TCG_NV_INDEX_DYNAMIC_EVENT_LOG_STRUCT_SPDM_CHALLENGE_AUTH (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",            TCG_NV_INDEX_DYNAMIC_EVENT_LOG_STRUCT),
    ("DescriptionSize",   UINT16                               ),
    ("Description",       UINT8 * len (TCG_SPDM_CHALLENGE_AUTH_DESCRIPTION)),
    ("DataSize",          UINT16),
    ("Data",              UINT8 * 32)
  ]
...
class TCG_NV_INDEX_DYNAMIC_EVENT_LOG_STRUCT_SPDM_MEASUREMENTS (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",            TCG_NV_INDEX_DYNAMIC_EVENT_LOG_STRUCT),
    ("DescriptionSize",   UINT16                               ),
    ("Description",       UINT8 * len (TCG_SPDM_MEASUREMENTS_DESCRIPTION)),
    ("DataSize",          UINT16),
    ("Data",              UINT8 * 32)
  ]
