...
EFI_IMAGE_FILE_LARGE_ADDRESS_AWARE  = BIT5
...
class RUNTIME_FUNCTION (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("FunctionStartAddress",  UINT32),
    ("FunctionEndAddress",    UINT32),
    ("UnwindInfoAddress",     UINT32)
  ]

class UNWIND_INFO (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Version",             UINT8 ,3),
    ("Flags",               UINT8 ,5),
    ("SizeOfProlog",        UINT8 ),
    ("CountOfUnwindCodes",  UINT8 ),
    ("FrameRegister",       UINT8 ,4),
    ("FrameRegisterOffset", UINT8 ,4)
  ]
