...
EFI_COMPUTING_UNIT_MANAGEABILITY      = (EFI_COMPUTING_UNIT | 0x00070000)
...
EFI_MANAGEABILITY_EC_REDFISH_COMMUNICATION_ERROR         = (EFI_SUBCLASS_SPECIFIC | 0x00000000)
EFI_MANAGEABILITY_EC_REDFISH_HOST_INTERFACE_ERROR        = (EFI_SUBCLASS_SPECIFIC | 0x00000001)
...
EFI_SW_EC_WRITE_PROTECTED          = 0x00000012
EFI_SW_EC_FV_CORRUPTED             = 0x00000013
EFI_SW_EC_INCONSISTENT_MEMORY_MAP  = 0x00000014
